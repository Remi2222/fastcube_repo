  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.id) {
        ...
        navigate('/login?message=inscription_reussie');
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">Créez votre compte et accédez à nos services</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group">
              <label htmlFor="company" className="block text-sm font-semibold text-gray-700 mb-3">
                Entreprise <span className="text-gray-500 text-sm">(optionnel)</span>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <FaBuilding className="h-5 w-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-200" />
                </div>
                <input
                  type="text"
                  id="company"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group">
                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? <FaCheckCircle className="w-5 h-5" /> : <FaLock className="w-5 h-5" />}
                  </button>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-600 focus:outline-none transition-colors duration-200"
                  >
                    {showConfirmPassword ? <FaCheckCircle className="w-5 h-5" /> : <FaLock className="w-5 h-5" />}
                  </button>
                </div>
              </div>
            </div>
